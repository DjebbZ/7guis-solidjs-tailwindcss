...
const App: Component = () => {
  ...
  return (
    <div class="border-1 border-neutral-600 rounded-md m-2">
      <div class="grid grid-cols-10 p-2 bg-gradient-to-b from-neutral-100 to-neutral-300 border-b-1 border-neutral-600 rounded-t-md">
        ...
        <h1 class="align-text-top leading-none">Counter</h1>
      </div>
      <div class="grid grid-cols-2 gap-3 p-2 bg-gray-50 rounded-b-md">
        <input
          type="text"
          value={count()}
          class="border-1 border-neutral-200 shadow-inner bg-white px-1"
        />
        <button
          onClick={() => send({ type: "INCREMENT" })}
          class="px-4 border-1 rounded-md border-neutral-500 bg-gradient-to-b from-white via-neutral-50 to-neutral-300  hover:to-neutral-400 active:bg-neutral-200"
        >
          Count
        </button>
      </div>
